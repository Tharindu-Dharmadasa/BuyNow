...
<head>
    ...
    <title>Manage Products | Admins | BuyNow</title>
        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-black py-2 text-center">
                        <span class="fs-4 fw-bold text-white">Title</span>
                    </div>
                    <div class="col-4 col-lg-2 d-lg-block bg-light py-2 text-center">
                        <span class="fs-4 fw-bold">Price</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-black py-2 text-center">
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            <?php
                            $image_rs = Database::search("SELECT * FROM `images` WHERE `products_id`='" . $selected_data["id"] . "'");
                            $image_num = $image_rs->num_rows;
                            if ($image_num == 0) {
                            ?>
                                <img src="resources/mobile_images/iphone12.jpg" style="height: 40px;margin-left: 80px;" />
                            <?php
                            } else {
                                $image_data = $image_rs->fetch_assoc();
                            ?>
                                <img src="<?php echo $image_data["code"]; ?>" style="height: 80px;width: 80px ;margin-left: 80px;" />
                            <?php
                            }
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2 text-center">
                            <span class="fs-5 fw-bold"><?php echo $selected_data["added_datetime"]; ?></span>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea cols="10" rows="5" class="form-control overflow-scroll" readonly>
                                    <?php echo $selected_data["description"]; ?></textarea><br />
                                </div>
                            </div>
            ...
            <div class="col-12 mb-3">
                <div class="row gap-1 justify-content-center">
                    ...
                    ?>
                        <div class="col-12 col-lg-3 border border-danger rounded" style="height: 50px;" onclick="deleteCategory();">
                            <div class="row">
            ...
            <div class="modal" tabindex="-1" id="deleteCategoryModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-12">
                                <label class="form-label">Are you want to delete this category? </label>
                            </div>
                        
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary" onclick="verifyDeleteCategory(<?php echo $category_data['id']; ?>);">Delete Category</button>
                        </div>
                    </div>
                </div>
            </div>
